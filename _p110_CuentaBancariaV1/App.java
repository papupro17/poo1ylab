...
public class App {
    public static void main(String[] args) {
        ...
        Cliente cliente2 = new Cliente("Daniel Pepito de los pepitos:", new CuentaBancaria(1000));
        ...
        Banco miBanco = new Banco("Banco el chaparro SA de CV ", "Clase las Escondida S/N");
